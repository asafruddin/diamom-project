...
1. **Given** analytics or error monitoring is enabled  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/lib/analytics.ts.
...
- [ ] Implement Add Privacy-Safe Analytics and Diagnostics (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 9.3 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `9-2-recover-interrupted-sessions`.
