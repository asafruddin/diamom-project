...
1. **Given** the MVP stores profile, pregnancy, VAS, history, emergency contact, settings, or session data  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/constants/privacy.ts, src/lib/sensitive-data.ts, src/lib/analytics.ts.
...
- [ ] Implement Define Local-Only Privacy and Sensitive Data Rules (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 1.4 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `1-3-establish-claim-safe-copy-and-disclaimer-rules`.
