...
1. **Given** the user opens privacy/data settings  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/settings/privacy.tsx, src/services/local-data.service.ts, src/db/repositories/.
...
- [ ] Implement Delete Local Data (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 7.4 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `7-3-provide-privacy-terms-and-disclaimer-screens`.
