...
1. **Given** movement content exists  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/movements/index.tsx, app/movements/[movementId].tsx, src/features/movements/.
...
- [ ] Implement Build Labor Dance Movement List and Details (AC: 1)
...
**Offline Learning Materials and Movement Education** — Users can learn Labor Dance, SOP guidance, breathing exercises, and movement details through reviewed offline educational content with preparation, benefits, safety notes, warnings, equipment, and companion requirements.

Offline education story: use local reviewed Bahasa Indonesia content with governance metadata and no backend dependency.

### Source Requirements

- `docs/planning-artifacts/epics.md` Story 4.5 is the source of truth for the story statement and acceptance criteria.
...
- `app/movements/index.tsx`
- `app/movements/[movementId].tsx`
...
- Previous available story key: `4-4-build-breathing-exercise-catalog-and-details`.
