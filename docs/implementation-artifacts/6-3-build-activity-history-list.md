...
1. **Given** saved activity records exist  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/history/index.tsx, src/features/history/.
...
- [ ] Implement Build Activity History List (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 6.3 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `6-2-build-claim-safe-result-summary`.
