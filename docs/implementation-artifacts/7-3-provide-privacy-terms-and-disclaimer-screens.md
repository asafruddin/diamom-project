...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/settings/privacy.tsx, app/settings/terms.tsx, src/content/disclaimers.id.json.
...
- [ ] Implement Provide Privacy, Terms, and Disclaimer Screens (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 7.3 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `7-2-manage-emergency-contacts`.
