...
1. **Given** reviewed local materials exist  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/(tabs)/materials.tsx, app/materials/[materialId].tsx, src/features/materials/.
...
- [ ] Implement Build Material List and Detail Navigation (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 4.2 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `4-1-create-local-reviewed-content-structure`.
