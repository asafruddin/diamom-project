...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/modal/pause-session.tsx, app/modal/stop-session.tsx, src/stores/session.store.ts.
...
- [ ] Implement Implement Pause and Stop Controls (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 5.6 is the source of truth for the story statement and acceptance criteria.
...
- `app/modal/pause-session.tsx`
- `app/modal/stop-session.tsx`
...
- Previous available story key: `5-5-build-guided-timer-and-movement-instruction-surface`.
