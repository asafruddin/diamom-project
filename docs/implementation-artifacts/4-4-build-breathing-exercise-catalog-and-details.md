...
1. **Given** breathing content exists  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/breathing/index.tsx, app/breathing/[exerciseId].tsx, src/features/breathing/.
...
- [ ] Implement Build Breathing Exercise Catalog and Details (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 4.4 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `4-3-build-sop-labor-dance-cards`.
