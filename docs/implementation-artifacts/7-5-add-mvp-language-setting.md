...
1. **Given** the user opens language settings  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/stores/app.store.ts, app/settings/language.tsx.
...
- [ ] Implement Add MVP Language Setting (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 7.5 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `7-4-delete-local-data`.
