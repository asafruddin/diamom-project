...
1. **Given** the user starts the prepared session  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/session/timer.tsx, src/features/session/, src/services/session.service.ts.
...
- [ ] Implement Build Guided Timer and Movement Instruction Surface (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 5.5 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `5-4-build-session-selection-and-preparation`.
