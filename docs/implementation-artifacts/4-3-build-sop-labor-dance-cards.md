...
1. **Given** the user opens SOP Labor Dance  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/materials/sop.tsx, src/features/materials/.
...
- [ ] Implement Build SOP Labor Dance Cards (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 4.3 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `4-2-build-material-list-and-detail-navigation`.
