...
1. **Given** a safety screening or pre-session check includes a risky condition  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/constants/safety.ts, src/features/session/safety-gating.ts.
...
- [ ] Implement Implement Safety Gating and Education-Only Access (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 2.5 is the source of truth for the story statement and acceptance criteria.
...
- `src/features/session/safety-gating.ts`
...
- Previous available story key: `2-4-implement-first-use-safety-screening`.
