...
1. **Given** a history record exists  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/history/[recordId].tsx, src/db/repositories/.
...
- [ ] Implement Build History Detail and Delete Record (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 6.4 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `6-3-build-activity-history-list`.
