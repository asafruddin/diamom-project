...
1. **Given** onboarding, disclaimer, and safety screening are complete  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/(tabs)/_layout.tsx, app/(tabs)/home.tsx, app/(tabs)/materials.tsx, app/(tabs)/training.tsx, app/(tabs)/vas.tsx, app/(tabs)/profile.tsx.
...
- [ ] Implement Build Protected Main Tab Navigation (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 3.1 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `2-6-add-complete-pregnancy-exercise-warning-signs`.
