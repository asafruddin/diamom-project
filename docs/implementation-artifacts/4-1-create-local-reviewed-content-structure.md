...
1. **Given** the MVP content is stored locally  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/content/materials.id.json, src/content/movements.id.json, src/content/breathing.id.json, src/content/disclaimers.id.json.
...
- [ ] Implement Create Local Reviewed Content Structure (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 4.1 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `3-3-add-quick-start-with-eligibility-checks`.
