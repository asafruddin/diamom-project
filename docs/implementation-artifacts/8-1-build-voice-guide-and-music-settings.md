...
1. **Given** the user opens `Pengaturan Panduan Suara`  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/settings/voice-guide.tsx, src/lib/audio.ts, src/stores/app.store.ts.
...
- [ ] Implement Build Voice Guide and Music Settings (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 8.1 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `7-5-add-mvp-language-setting`.
