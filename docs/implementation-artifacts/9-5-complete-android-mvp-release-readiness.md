...
1. **Given** implementation stories are complete  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially eas.json, README.md, docs/implementation-artifacts/release-readiness.md.
...
- [ ] Implement Complete Android MVP Release Readiness (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 9.5 is the source of truth for the story statement and acceptance criteria.
...
- `eas.json`
- `README.md`
- `docs/implementation-artifacts/release-readiness.md`
...
- Previous available story key: `9-4-add-automated-tests-for-safety-critical-logic`.
