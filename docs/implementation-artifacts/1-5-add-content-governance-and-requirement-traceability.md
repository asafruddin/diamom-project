...
1. **Given** educational, breathing, movement, disclaimer, or safety content exists  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/content/content-governance.ts, src/constants/traceability.ts.
...
- [ ] Implement Add Content Governance and Requirement Traceability (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 1.5 is the source of truth for the story statement and acceptance criteria.
...
- `src/content/content-governance.ts`
- `src/constants/traceability.ts`
...
- Previous available story key: `1-4-define-local-only-privacy-and-sensitive-data-rules`.
