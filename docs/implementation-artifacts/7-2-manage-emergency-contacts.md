...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/settings/emergency-contact.tsx, src/services/emergency-call.service.ts.
...
- [ ] Implement Manage Emergency Contacts (AC: 1)
...
**Profile, Emergency Contact, Privacy, and Data Controls** — Users can manage their profile, pregnancy detail, emergency contact, language preference, privacy/terms access, and local data deletion from the profile/settings area.

Profile/settings story: keep sensitive pregnancy/contact data local and support user control over stored data.

### Source Requirements

- `docs/planning-artifacts/epics.md` Story 7.2 is the source of truth for the story statement and acceptance criteria.
...
- `app/settings/emergency-contact.tsx`
...
- Previous available story key: `7-1-build-profile-overview-and-edit-profile`.
