...
1. **Given** pre-session safety check is passed  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/session/vas-before.tsx, src/features/vas/, src/services/vas.service.ts.
...
- [ ] Implement Build VAS Before Assessment (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 5.3 is the source of truth for the story statement and acceptance criteria.
...
- `app/session/vas-before.tsx`
- `src/features/vas/`
- `src/services/vas.service.ts`
...
- Previous available story key: `5-2-build-pre-session-safety-check`.
