...
1. **Given** a session reaches completion or normal stop  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/session/vas-after.tsx, app/session/result.tsx, src/features/vas/.
...
- [ ] Implement Build VAS After and Incomplete Result Behavior (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 5.8 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `5-7-implement-emergency-stop-and-contact-access`.
