...
1. **Given** the user opens `Pengingat Latihan`  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/settings/notifications.tsx, src/lib/notifications.ts.
...
- [ ] Implement Build Reminder Permission and Settings (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 8.3 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `8-2-integrate-audio-playback-with-session-state`.
