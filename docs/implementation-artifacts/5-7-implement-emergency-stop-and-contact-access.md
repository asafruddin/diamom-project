...
1. **Given** a session is running or paused  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/modal/emergency-stop.tsx, src/services/emergency-call.service.ts.
...
- [ ] Implement Implement Emergency Stop and Contact Access (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 5.7 is the source of truth for the story statement and acceptance criteria.
...
- `app/modal/emergency-stop.tsx`
- `src/services/emergency-call.service.ts`
...
- Previous available story key: `5-6-implement-pause-and-stop-controls`.
