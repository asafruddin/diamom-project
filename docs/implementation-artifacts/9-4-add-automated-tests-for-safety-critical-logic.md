...
1. **Given** the app has VAS, safety, session, forms, and repositories  
   **When** tests run  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/**/*.test.ts, src/**/*.test.tsx.
...
- [ ] Implement Add Automated Tests for Safety-Critical Logic (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 9.4 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `9-3-add-privacy-safe-analytics-and-diagnostics`.
