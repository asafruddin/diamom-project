...
1. **Given** the user reaches the consent screen  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/onboarding/consent.tsx, app/settings/terms.tsx, src/content/disclaimers.id.json.
...
- [ ] Implement Require Medical Disclaimer Consent Before Activity Access (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 2.3 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `2-2-validate-pregnancy-information-and-provider-approval`.
