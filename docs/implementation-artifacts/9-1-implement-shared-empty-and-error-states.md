...
1. **Given** no history, no internet, failed result save, audio load failure, incomplete VAS, or interrupted session occurs  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/components/common/EmptyState.tsx, src/components/common/ErrorState.tsx.
...
- [ ] Implement Implement Shared Empty and Error States (AC: 1)
...
**Resilience, Analytics Safety, QA, and Release Readiness** — Users experience graceful empty/error states, recover interrupted sessions, and benefit from a tested Android MVP whose analytics and diagnostics avoid sensitive health data.

Release hardening story: focus on shared resilience, privacy-safe diagnostics, test coverage, and Android MVP readiness.

### Source Requirements

- `docs/planning-artifacts/epics.md` Story 9.1 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `8-4-schedule-and-manage-local-notifications`.
