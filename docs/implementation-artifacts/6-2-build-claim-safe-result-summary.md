...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/session/result.tsx, src/features/session/result-summary.tsx.
...
- [ ] Implement Build Claim-Safe Result Summary (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 6.2 is the source of truth for the story statement and acceptance criteria.
...
- `src/features/session/result-summary.tsx`
...
- Previous available story key: `6-1-implement-local-session-and-vas-persistence`.
