...
1. **Given** VAS before is complete  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/session/choose-duration.tsx, app/session/preparation.tsx, src/features/session/.
...
- [ ] Implement Build Session Selection and Preparation (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 5.4 is the source of truth for the story statement and acceptance criteria.
...
- `app/session/choose-duration.tsx`
- `app/session/preparation.tsx`
...
- Previous available story key: `5-3-build-vas-before-assessment`.
