...
1. **Given** the user has accepted the disclaimer  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/onboarding/safety-screening.tsx, src/constants/safety.ts, src/features/onboarding/.
...
- [ ] Implement Implement First-Use Safety Screening (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 2.4 is the source of truth for the story statement and acceptance criteria.
...
- `app/onboarding/safety-screening.tsx`
...
- Previous available story key: `2-3-require-medical-disclaimer-consent-before-activity-access`.
