...
1. **Given** the user selects VAS 9 or 10 before or after activity  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/features/vas/high-score-guidance.ts, src/constants/safety.ts.
...
- [ ] Implement Apply High VAS Safety Guidance (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 5.9 is the source of truth for the story statement and acceptance criteria.
...
- `src/features/vas/high-score-guidance.ts`
...
- Previous available story key: `5-8-build-vas-after-and-incomplete-result-behavior`.
