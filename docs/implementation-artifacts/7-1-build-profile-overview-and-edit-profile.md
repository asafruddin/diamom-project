...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/(tabs)/profile.tsx, src/features/profile/, src/stores/user.store.ts.
...
- [ ] Implement Build Profile Overview and Edit Profile (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 7.1 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `6-5-build-vas-progress-chart`.
