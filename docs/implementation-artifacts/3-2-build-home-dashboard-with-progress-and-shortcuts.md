...
1. **Given** the user lands on `Beranda`  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/(tabs)/home.tsx, src/features/home/.
...
- [ ] Implement Build Home Dashboard With Progress and Shortcuts (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 3.2 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `3-1-build-protected-main-tab-navigation`.
