...
1. **Given** the user views breathing or movement details  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/features/session/route-guards.ts, src/features/materials/.
...
- [ ] Implement Connect Learning Content to Safe Practice Entry (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 4.6 is the source of truth for the story statement and acceptance criteria.
...
- `src/features/session/route-guards.ts`
...
- Previous available story key: `4-5-build-labor-dance-movement-list-and-details`.
