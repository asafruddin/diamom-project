...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially app/onboarding/intro.tsx, app/onboarding/profile.tsx, src/features/onboarding/.
...
- [ ] Implement Complete Onboarding Introduction and Mother Profile Form (AC: 1)
...
- `docs/planning-artifacts/epics.md` Story 2.1 is the source of truth for the story statement and acceptance criteria.
...
- Previous available story key: `1-5-add-content-governance-and-requirement-traceability`.
