...
1. **Given** the user taps the home start-session CTA  
...
- [ ] Confirm story scope and existing implementation (AC: all)
  ...
  - [ ] Inspect existing files before editing, especially src/features/home/quick-start.ts, src/features/session/route-guards.ts.
...
- [ ] Implement Add Quick Start With Eligibility Checks (AC: 1)
...
**Home Dashboard and Core Navigation** — Returning users can land on a calm home dashboard, see progress context, and reach the core DiaMom areas quickly: start session, materials, VAS, history, and profile.

Navigation/home story: preserve Expo Router typed routes and protect prerequisite flows before activity access.

### Source Requirements

- `docs/planning-artifacts/epics.md` Story 3.3 is the source of truth for the story statement and acceptance criteria.
...
- `src/features/home/quick-start.ts`
...
- Previous available story key: `3-2-build-home-dashboard-with-progress-and-shortcuts`.
